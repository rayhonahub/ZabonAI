    ...
    <div className="min-h-screen flex items-center justify-center bg-ink px-4 page-enter">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card p-8">
          <h2 className="text-xl font-bold text-white font-sora mb-0.5">Create account</h2>
          <p className="text-sm text-white/40 mb-6">Создать аккаунт</p>

          {refCode && (
            <div className="mb-4 text-sm bg-primary/10 text-primary-light border border-primary/20 rounded-xl px-3 py-2.5 animate-fade-in">
